...
function initMap(){
    ...
    map.centerAndZoom(new BMap.Point(111.288234,23.484994), 14);  // 初始化地图,设置中心点坐标和地图级别
    map.addControl(new BMap.MapTypeControl());   //添加地图类型控件
    map.setCurrentCity("重庆");          // 设置地图显示的地区 此项是必须设置的
...
//    map.addOverlay(marker2);              // 将标注添加到地图中
    ...
    /*ajaxCallback("listJ",{table:"user"},function(list){
        tempparklist = list;
